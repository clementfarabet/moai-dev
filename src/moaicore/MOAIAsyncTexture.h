...
#ifndef	MOAIASYNCTEXTURE_H
#define	MOAIASYNCTEXTURE_H
...
// MOAIAsyncTexture
//================================================================//
/**	@name	MOAIAsyncTexture
	@text	Texture class.
*/
class MOAIAsyncTexture :
...
public:
	...
	DECL_LUA_FACTORY ( MOAIAsyncTexture )
	...
	void					AsyncInit				( MOAIDataBuffer& data, u32 transform, cc8* debugname );
